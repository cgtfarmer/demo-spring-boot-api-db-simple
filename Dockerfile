FROM maven:3.9.6-amazoncorretto-17 AS demo-spring-boot-api-db-simple-build
...
FROM maven:3.9.6-amazoncorretto-17 AS demo-spring-boot-api-db-simple-development
...
COPY --from=demo-spring-boot-api-db-simple-build ${MAVEN_BUILD_REPO} ${MAVEN_BUILD_REPO}
